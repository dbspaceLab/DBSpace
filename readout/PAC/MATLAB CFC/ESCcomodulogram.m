function MIs = ESCcomodulogram(sigForAmp,sigForPhase,freqForAmp,freqForPhase,fs,bw,passbandRipl,option)
%ESCCOMODULOGRAM Generates a Envelope-to-Signal-Correlation Based Comodulogram
...
%   option: 'Yes' show comodulogram; 'No' don't show comodulogram
    ...
    ModCorr = EnvSigCorrCFC(oscAmpMod,oscForPhase,freqForAmp,freqForPhase);
