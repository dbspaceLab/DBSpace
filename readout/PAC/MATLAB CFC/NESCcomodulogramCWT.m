function MIs = NESCcomodulogramCWT(sigForAmp,sigForPhase,freqForAmp,freqForPhase,fs,Fb,Fc,option)
%NESCCOMODULOGRAMCWT Generates a Normalized-Envelope-to-Signal-Correlation Based Comodulogram
%   USAGE: MIs = NESCcomodulogramCWT(sigForAmp,sigForPhase,freqForAmp,freqForPhase,fs,Fb,Fc,option)
...
%   option: 'Yes' show comodulogram; 'No' don't show comodulogram
    ...
    ModCorr = NormEnvSigCorrCFCwav(coefsForAmp,coefsForPhase,freqForAmp,freqForPhase);
