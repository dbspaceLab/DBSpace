...
from dbspace.signal.oscillations import poly_subtr, gen_psd
...
class sim_amp:
    ...
    def gen_recording(self, Z1, Z3):
        ...
        return y_out, diff_out

    def simulate(self, Z1, Z3):
        # pre_Fs = self.diff_inst.Fs
    ...
    def plot_simulation(
        ...
        diff_out = sig.decimate(self.diff_out, display_downsample)
        ...
        _, _, self.SGdiff = sig.spectrogram(
            ...
            fs=self.diff_inst.Fs / display_downsample,
        )
    ...
    def plot_osc_power(self):
        ...
        bl_psd = gen_psd(bl_ts, polyord=0)
        stim_psd = gen_psd(stim_ts, polyord=0)
        ...
        plt.subplot(3, 2, 2)
        bl_psd = gen_psd(bl_ts, polyord=4)
        stim_psd = gen_psd(stim_ts, polyord=4)
        ...
        if sg_avg:
            ...
            corr_bl = poly_subtr(bl_P, F)
            corr_stim = poly_subtr(stim_P, F)
